...
<div class="container-fluid keranjang p-2" style="margin-top: 90px;">
 ...
 <div class="container">
  <nav class="navbar justify-content-center text-white mb-4">
      <a href="{{ url('produkwanita') }}"  class="btn btn-secondary text-white btn-sm gender btn-outline-secondary m-1" type="button">Wanita</a>
      <a href="{{ url('semuaproduk') }}"  class="btn btn-sm gender btn-outline-secondary m-1" type="button">Semua</a>
      <a href="{{ url('produkpria') }}"   class="btn btn-sm gender  btn-outline-secondary m-1" type="button">Pria</a>
    
  </nav>
    <div class="row">
      @foreach ($produkwanita as $prod)
