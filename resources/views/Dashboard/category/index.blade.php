...
@section('conten')
    ...
    <a href="{{ url('add-category') }}" class="btn btnproduk mb-3 ">Tambah Category <span
            ...
            <tbody>
                @foreach ($category as $item)
                    <tr>
                        ...
                        <td>
                            <div class="">
                                <a href="{{ url('edit-category/' . $item->id) }}" class="btn btn-danger"> <i
                                        class="fa-regular fa-pen-to-square"> Edit</i></a>
                                <a href="{{ url('delete-category/' . $item->id) }}" class="btn btn-primary"> <i
